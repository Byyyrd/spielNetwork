...
public class Inventory {
    ...
    public void updateInv() {
        ...
        if (equipButtons[0] != null) {
            ...
            slingshotDamage = equipButtons[0].getButton().item.getSlingshotDamage() + equipButtons[1].getButton().item.getSlingshotDamage() + equipButtons[2].getButton().item.getSlingshotDamage() + equipButtons[3].getButton().item.getSlingshotDamage() + equipButtons[4].getButton().item.getSlingshotDamage() + equipButtons[5].getButton().item.getSlingshotDamage() + equipButtons[6].getButton().item.getSlingshotDamage();
            ...
            slingshotDamageReduction = equipButtons[0].getButton().item.getSlingshotDamageReduction() + equipButtons[1].getButton().item.getSlingshotDamageReduction() + equipButtons[2].getButton().item.getSlingshotDamageReduction() + equipButtons[3].getButton().item.getSlingshotDamageReduction() + equipButtons[4].getButton().item.getSlingshotDamageReduction() + equipButtons[5].getButton().item.getSlingshotDamageReduction() + equipButtons[6].getButton().item.getSlingshotDamageReduction();
